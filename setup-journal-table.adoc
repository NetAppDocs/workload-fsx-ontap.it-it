...
* Impostare la configurazione di rete su *Internet* per il punto di accesso S3. link:edit-s3-access-points.html["Modifica la configurazione di rete per il punto di accesso S3"].
...
Se uno qualsiasi di questi passaggi non dovesse funzionare, <<Risoluzione dei problemi di configurazione dell'infrastruttura per la tabella del journal,risolvere i problemi di configurazione dell'infrastruttura per la tabella del registro>> o contatta il supporto NetApp per assistenza.
