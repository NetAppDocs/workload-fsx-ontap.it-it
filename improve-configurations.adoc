...
* Ottimizzazione dei costi: efficienze di archiviazione, suddivisione in livelli dei dati, eliminazione di snapshot e backup non necessari e dispositivi a blocchi inattivi
