...
* Eccellenza operativa: gestione automatica della capacità, soglia di utilizzo della capacità del file di volume, utilizzo del volume quasi completo e modalità di scrittura della relazione della cache
* Ottimizzazione dei costi: efficienza di archiviazione, suddivisione in livelli dei dati, eliminazione di snapshot e backup non necessari
...
.Prima di iniziare
* Devilink:link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["concedere autorizzazioni per _operazioni e bonifica_"^] nel tuo account AWS.
