...
* Sicurezza: protezione autonoma da ransomware NetApp con intelligenza artificiale (ARP/AI) e accesso non autorizzato ai volumi
* Eccellenza operativa: gestione automatica della capacità, soglia di utilizzo della capacità dei file di volume e utilizzo del volume prossimo al completo
* Ottimizzazione dei costi: efficienza di archiviazione, suddivisione in livelli dei dati ed eliminazione non necessaria degli snapshot
* Ottimizzazione delle prestazioni: ribilanciamento dei volumi FlexGroup
