...
* Affidabilità: soglia di capacità SSD, snapshot locali pianificate, backup dei volumi pianificati, replica dei dati remota, affidabilità dei dati per la conservazione a lungo termine e collegamento degli host al nodo di failover
...
* Efficienza delle prestazioni: collega gli host al nodo preferito
