...
+
--
* *Workload Genai*: Replica dei dati dei volumi ONTAP on-premise in un file system FSX per ONTAP in modo che i dati possano essere utilizzati in link:https://docs.netapp.com/us-en/workload-genai/create-knowledgebase.html["Arricchire le knowledge base dell'ai"^].
...
Replica dei dati del volume da un cluster ONTAP on-premise in un file system FSX per ONTAP. Una volta replicati, i dati possono essere utilizzati per arricchire le knowledge base dell'ai.
