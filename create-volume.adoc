...
.. *Endpoint S3*: facoltativamente, collega un endpoint S3 per accedere ai dati del file system FSx for ONTAP residenti su volumi NFS o SMB/CIFS tramite le API AWS S3.  È supportato solo il tipo di accesso ai file.  Fornendo i seguenti dettagli:
+
*** *Nome endpoint S3*: immettere il nome dell'endpoint S3.
