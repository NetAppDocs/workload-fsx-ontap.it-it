...
. Nella scheda *FSX per ONTAP*, seleziona il menu a tre punti del file system in cui desideri creare un volume e seleziona *Gestisci*.
. Dalla scheda *Panoramica*, selezionare *Crea volume*.
