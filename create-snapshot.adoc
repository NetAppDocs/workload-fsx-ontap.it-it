...
NOTE: Gli snapshot non sono copie dei tuoi dati. Se desideri creare copie dei tuoi dati, valuta l'utilizzo delle funzionalità di backup del volume o di replica del volume.
