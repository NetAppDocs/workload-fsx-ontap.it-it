...
[role="lead"]
Creare una relazione di replica per un file system FSx for ONTAP in NetApp Workload Factory per evitare la perdita di dati in caso di un disastro imprevisto.
...
* Per creare una relazione di replicazione, è necessario disporre di due file system disponibili nel tuo Storage.
