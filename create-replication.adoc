...
[role="lead"]
Crea una relazione di replica per un file system FSx for ONTAP in NetApp Workload Factory per evitare la perdita di dati in caso di disastro imprevisto. Puoi replicare i dati tra due file system FSx for ONTAP oppure tra un sistema ONTAP locale e un file system FSx for ONTAP.
