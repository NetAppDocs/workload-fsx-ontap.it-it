...
. Dalla schermata Gestisci VM di archiviazione, seleziona il menu delle azioni della VM di archiviazione per cui configurare Active Directory, quindi seleziona *Azioni di base* > *Gestisci configurazione AD*.
