...
Per ulteriori informazioni sui cyber vault e su come impostare questa architettura, fare riferimento alink:https://docs.netapp.com/us-en/netapp-solutions-dataops/cyber-vault/ontap-cyber-vault-overview.html["Documentazione del cyber vault ONTAP"^] .
