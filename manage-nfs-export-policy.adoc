...
summary: Gestire la policy di esportazione NFS per un volume che utilizza i tipi di protocollo NFSv3 o NFSv4.1 in NetApp Workload Factory. 
---
= Gestire la policy di esportazione NFS per un volume in NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
Gestire la policy di esportazione NFS per un volume che utilizza i tipi di protocollo NFSv3 o NFSv4.1 in NetApp Workload Factory.
...
. Dalla scheda Volumi, selezionare il menu delle azioni per il volume per cui si desidera modificare la policy di esportazione NFS.
