...
---
= Dividi un volume clonato in NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
Dividere un FlexVol volume clonato dal suo volume padre per trasformare il clone in un normale FlexVol volume di lettura/scrittura in NetApp Workload Factory.
...
. Da *FSx for ONTAP*, seleziona il menu azioni del file system con il clone del volume da dividere, quindi seleziona *Gestisci*.
. Nella panoramica del file system, selezionare la scheda *volumi*.
. Nella scheda Volumi, selezionare il menu azioni del volume contenente il volume clonato da dividere.
